...
// invoked, any number of times. Functions often use their argument values to compute a
// return value that becomes the value of the function-invocation expression.

// JavaScript functions are parameterized: a function definition may include a list of identifiers, known as ***********parameters, that work as local variables for the body of the function. Function invocations provide values, or arguments, for the function’s parameters.
...
// created object are called ***********constructors. Constructors were described in §6.2 and will be
